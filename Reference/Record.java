//To rerun the examples, just copy the part and paste into Test.java and run command by "javac Test.java && java Test"

// Detect the file existing, 9/25/2017
{
...
public class Test {
    ...
    public Test() {
		File tmpDir = new File("write.txt");
...
// Jtable display in jTextPane example, 9/25/2017
